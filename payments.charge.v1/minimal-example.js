/**
 * Minimal Example: payments.charge.v1 Policy
 *
 * This is a quick-start example showing the basic usage of the payments.charge.v1 policy.
...
app.post("/charge", requirePolicy("payments.charge.v1"), async (req, res) => {
  try {
...
app.listen(PORT, () => {
  ...
  console.log("Protected by APort payments.charge.v1 policy");
  console.log(
