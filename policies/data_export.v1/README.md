...
```markdown
[![Data Export-Ready](https://api.aport.dev/badge/ap_12345678.svg)](https://aport.dev/agents/ap_12345678)
```

## Support

- [Documentation](https://aport.dev/docs/policies/data_export.v1)
