...
class TestRefundsV1Policy:
    """Test suite for payments.refund.v1 policy functionality"""
    ...
    def test_required_fields_validation_success(self, valid_context):
        ...
        with patch('agent_passport.policy_enforcement.verify_policy_compliance') as mock_verify:
            ...
            result = check_policy_sync("agent_123", "payments.refund.v1", valid_context)
    ...
    def test_required_fields_validation_failure(self):
        ...
        with patch('agent_passport.policy_enforcement.verify_policy_compliance') as mock_verify:
            ...
            result = check_policy_sync("agent_123", "payments.refund.v1", invalid_context)
    ...
    def test_currency_support(self):
        ...
        for currency in currencies:
            ...
            with patch('agent_passport.policy_enforcement.verify_policy_compliance') as mock_verify:
                ...
                result = check_policy_sync("agent_123", "payments.refund.v1", context)
    ...
    def test_error_handling_policy_verification_failure(self):
        ...
        with patch('agent_passport.policy_enforcement.verify_policy_compliance') as mock_verify:
            ...
            result = check_policy_sync("agent_123", "payments.refund.v1", {})
...
class TestRefundsV1PolicyIntegration:
    """Integration tests for payments.refund.v1 policy"""
    ...
    async def test_async_policy_compliance(self):
        ...
        with patch('agent_passport.policy_enforcement.verify_policy_compliance') as mock_verify:
            ...
            result = await check_policy_compliance("agent_123", "payments.refund.v1", context)
